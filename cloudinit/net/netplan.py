...
from cloudinit.net.network_state import NET_CONFIG_TO_                # present in `NET_CONFIG_TO_V2`. This could probably be removed
                ...
                # Previous cast is needed to help mypy to know that the key is b"""\
