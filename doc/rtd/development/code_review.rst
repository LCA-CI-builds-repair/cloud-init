...
* If CI fails:
  ...
  The **proposer** is expected to fix CI failures. If they don'tOnce the review comments are addressed, CI will run. If CI fails, the proposer
...
to get CI passing again.lures, they should comment on the PR to ask for help (or use another way
